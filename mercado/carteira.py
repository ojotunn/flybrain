...
ARQUIVO = Path(__file__).resolve().parent / 'carteira.json'
ARQ_SENHA = Path(__file__).resolve().parent / 'carteira.senha'   # modo automatico: senha aleatoria local (git ignora)
